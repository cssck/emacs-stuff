...
(my-emacs-comment
  ...
  (progn
    ...
    (add-to-list 'load-path "/home/aprilsnow/Git/Projects/standard-themes/")
    ...
    (mapcar (lambda (theme)
              (add-to-list
               ...
               (concat "/home/aprilsnow/Git/Projects/standard-themes/" (symbol-name theme) "-theme.el")))
...
(provide 'my-emacs-standard-themes)
