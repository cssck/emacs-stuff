;;; Dired file manager and my-dired.el extras
(use-package dired
  :ensure nil
  :commands (dired)
  :config
...
(use-package my-dired
  :ensure nil
  :hook (dired-mode . my-dired-setup-imenu)
  :bind
  ( :map dired-mode-map
    ("i" . my-dired-insert-subdir) ; override `dired-maybe-insert-subdir'
    ("/" . my-dired-limit-regexp)
    ("C-c C-l" . my-dired-limit-regexp)
    ("M-n" . my-dired-subdirectory-next)
    ("C-c C-s" . my-dired-search-flat-list)
    ("C-c C-n" . my-dired-subdirectory-next)
    ("C-c C-p" . my-dired-subdirectory-previous)
    ("M-s G" . my-dired-grep-marked-files) ; M-s g is `my-search-grep'
    ("M-p" . my-dired-subdirectory-previous)))
