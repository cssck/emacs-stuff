...
;;; accounts
  ...
  ;;                    (my-mail-auth-get-field "inf" :user)))))
  ;;         ("prv"
  ;;          (posting-style
  ;;           (gcc "nnmaildir+prv:Sent")
  ;;           (From
  ;;            (format "%s <%s>" user-full-name
  ;;                    (my-mail-auth-get-field "prv" :user)))))
  ;;         ("pub"
  ...
  (setq gnus-agent t)
  (setq gnus-novice-user t)           ; careful with this
  ;; checking sources
...
;;; summary
  ...
  (setq gnus-ignored-from-addresses "Yurii Skoryk")
