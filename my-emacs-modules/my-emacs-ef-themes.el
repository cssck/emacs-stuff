...
(my-emacs-comment
  ...
  (progn
    ...
    (add-to-list 'load-path "/home/aprilsnow/Git/Projects/ef-themes/")
    ...
    (mapcar (lambda (theme)
              (add-to-list
               ...
               (concat "/home/aprilsnow/Git/Projects/ef-themes/" (symbol-name theme) "-theme.el")))
