...
(use-package eww
  ...
  ( :map eww-mode-map
    ...
    ("b" . my-simple-buffers-major-mode) ; a general version to show buffer of current mode
    ("m" . bookmark-set)
    :map eww-link-keymap
...
(use-package my-eww
  ...
  ( :map eww-mode-map
    ("F" . my-eww-find-feed)
    ("o" . my-eww-open-in-other-window)
    ("j" . my-eww-jump-to-url-on-page)
    ("J" . my-eww-visit-url-on-page)))
...
(use-package elfeed
  ...
  (my-emacs-keybind elfeed-search-mode-map
...
(use-package my-elfeed
  ...
  ( :map elfeed-search-mode-map
    ...
    ("+" . my-elfeed-toggle-tag)
    :map elfeed-show-mode-map
    ("+" . my-elfeed-toggle-tag))
  :hook
  (elfeed-search-mode . my-elfeed-load-feeds)
  :config
  (setq my-elfeed-tag-faces t)
  (my-elfeed-fontify-tags))
