...
(use-package my-window
  ...
  :demand t
  :hook
  ((world-clock-mode calendar-mode) . my-common-truncate-lines-silently))
...
(use-package my-window
  ...
  :bind
  ( :map global-map
    ;; NOTE 2022-09-17: Also see `my-simple-swap-window-buffers'.
...
(use-package breadcrumb
  :ensure t
  :functions (my/breadcrumb-local-mode)
  :hook ((text-mode prog-mode) . my/breadcrumb-local-mode)
  :config
  ...
  (defun my/breadcrumb-local-mode ()
