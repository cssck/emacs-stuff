...
;; `standard-themes'.
(when my-emacs-load-theme-family
  (require
   (pcase my-emacs-load-theme-family
     ('ef 'my-emacs-ef-themes)
     ('modus 'my-emacs-modus-themes)
     ('standard 'my-emacs-standard-themes))))
...
(use-package rainbow-mode
  ...
  :hook (emacs-lisp-mode . my/rainbow-mode-in-themes))
...
(use-package face-remap
  :ensure nil
  :functions my/enable-variable-pitch
  :bind ( :map ctl-x-x-map
